...
sim_setup(
    ...
    fmax=500.0,
    save_folder='../../sim_data/LivingRoom/viz',  # can run python from here
    compress=0,
    draw_vox=True,
...
#   python3 -m pffdtd.sim3d.sim_fdtd --data_dir='../../sim_data/LivingRoom/viz' --plot --draw_backend='mayavi' --json_model='model.json'
