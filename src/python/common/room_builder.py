...
def main():
    ...
    builder.add_source("Speaker Left", [0.2, L-2.52-1.25+0.1, 0.8])
    builder.add_source("Speaker Right", [0.2, L-2.52-0.2, 0.8])
    builder.add_receiver("Listener", [1.0, L-2.52-1.4/2, 1.2])
    builder.add_box("Sofa", [0.98, 2.52, 0.48], [0.05, L-2.52-0.05, 0.06])
    builder.add_box("Table", [0.75, 1.25, 0.02], [0.05, L-2.52-0.05*2-1.25, 0.66])
